...
def DominoVpcStack(nest: bool, scope: cdk.Construct, construct_id: str, name: str, vpc: VPC, **kwargs):
    ...
    class _class(base):
        def __init__(self, nest: bool, scope: cdk.Construct, construct_id: str, name: str, vpc: VPC, **kwargs) -> None:
            if nest:
    ...
    global _DominoVpcStack
    if not _DominoVpcStack:
        _DominoVpcStack = _class
    return _DominoVpcStack(nest, scope, construct_id, name, vpc, **kwargs)
